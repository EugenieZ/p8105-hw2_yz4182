...
The number of observation in trashwheel\_df dataset is 344, and the key
...
The number of observation in precipitation\_com\_df dataset is 18. The
...
popl_babynames_df =
  ...
  distinct(year_of_birth, gender, ethnicity, childs_first_name, .keep_all = TRUE) # remove the duplicated rows
```
