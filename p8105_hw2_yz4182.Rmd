...
```
The dataset of "pols_month_df" contains 9 variables:`r names(pols_month_df)` and has a range from 1947-2015.
The dataset of "snp_df" contains 3 variables:`r names(snp_df)` and has a range from 1947-2015.
The dataset of "unemployment_df" contains 3 variables:`r names(unemployment_df)` and has a range from 1947-2015.
The resulting dataset "join_df" contains variables `r names(join_df)`.
